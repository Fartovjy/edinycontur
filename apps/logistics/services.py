...
ALLOWED_STATUS_TRANSITIONS = {
    ...
    STATUS_WAITING_ARRIVAL: {STATUS_IN_WAREHOUSE, STATUS_READY_TO_SHIP, STATUS_PROBLEM},
    STATUS_IN_WAREHOUSE: {STATUS_CZ_CHECK, STATUS_READY_TO_SHIP, STATUS_PROBLEM},
    STATUS_CZ_CHECK: {STATUS_READY_TO_SHIP, STATUS_PROBLEM},
    STATUS_READY_TO_SHIP: {STATUS_TRANSPORT_ASSIGNED, STATUS_SHIPPED, STATUS_PROBLEM},
